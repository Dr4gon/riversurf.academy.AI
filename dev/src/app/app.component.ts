...
@Component({
  ...
  // styles: [ require('./app.component.sass').default ], -> Can't be used with global styles.scss because in the webpack configuration a raw-loader with esModule: false would disable the styles.scss transformation
})
